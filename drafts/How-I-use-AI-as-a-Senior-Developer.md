...
When I here VibeCoding, I think that you just Vibe with the AI and blindly use the output of the LLM, it the UI it made feels right, use it, it the UX is right use it, but this create the problem of unmaintainable code.
...
I often combine this with Template Repos, and AI Augmented Development. This is how I actually see improvements in my workflow, this have its downsides.
